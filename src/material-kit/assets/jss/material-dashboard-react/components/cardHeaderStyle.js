...
const cardHeaderStyle = {
  cardHeader: {
    ...
    "&$cardHeaderPlain,&$cardHeaderIcon,&$cardHeaderStats,&$autoruneCardHeader,&$warningCardHeader,&$successCardHeader,&$dangerCardHeader,&$infoCardHeader,&$primaryCardHeader,&$roseCardHeader": {
      margin: "0 15px",
      padding: "0",
      color: whiteColor
    },
